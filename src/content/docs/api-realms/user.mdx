...
| `profile_picture_fid`  | Profile Picture File ID      | ID pointing to temporary save of the profile picture upload (**write-only**). For more details on uploading files: [File Uploading](../../api-documentation/files)                              | `integer`                          |
