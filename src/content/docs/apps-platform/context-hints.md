...
1.  The URL to launch your application in Schoology. When building out this part take care [to consider the domain](../handling-domains) the app was launched from. The rest of the URL has three wild cards:
