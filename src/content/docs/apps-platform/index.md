...
- Logout - Use the [app-user-info](../api-realms/user#get-app-user-info) endpoint to check for a Schoology web session.
...
:::tip
There are plenty of SAML libraries that can decode and validate this information for you - see our [client libraries section](../apps-platform/client-libraries).
:::
