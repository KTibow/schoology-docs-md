...
- The [Schoology PHP SDK](../../client-libraries) (included in project files)
...
<Tabs>
<TabItem label="lib/SchoologyApp.php">
...
The following function is responsible for importing content into Schoology ([see import workflow](../../../api-documentation/resource-apps#import-workflow)).
...
Congratulations on your first working Resource App! Resource Apps allow users to import content easily from third-party providers. Please refer to the [Resource Apps](../../../api-documentation/resource-apps) docs for further details.
