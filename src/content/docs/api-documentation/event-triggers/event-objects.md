---
title: "Triggers and Receiving Their Event Objects"
sidebar:
  order: 2
  label: "Event Objects"
---
...
`data`->`object` will contain [assignment fields](../../../api-objects/assignment)
...
`data`->`object` will contain [attendance fields](../../../api-objects/attendance)
...
`data`->`object` will contain [grade fields](../../../api-objects/grade)
