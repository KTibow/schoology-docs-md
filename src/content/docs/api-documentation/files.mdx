---
title: "Attaching Files, Links, Embeds, and Resources"
sidebar:
  order: 4
  label: "Files"
---
...
| Embed | resource         | - Note that the resource is an id of a [resource template](../../api-objects/resource-templates) of type **document**<br />- Resources are converted to a file during a POST/PUT<br />- On subsequent PUTs the attachment id should be sent in |
