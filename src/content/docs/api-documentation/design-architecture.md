...
The OAuth header validates you as an enabled API user. For more information about properly generating the required OAuth header, read our page on [OAuth](../authentication), and especially the links at the bottom of that page for getting started with using OAuth. To generate your Schoology API credentials, sign in to your account and visit https://www.schoology.com/api.
...
For some further help forming these requests, check out the [examples page](../examples) and the API reference.
